...
const Footer = () => {
  return (
    <div>
        <div className=' bg-gradient-to-r from-blue-900 to-indigo-900 text-slate-100 flex justify-between items-center px-10 py-8'>
            <div>
                <div className='text-2xl font-semibold'>
                TradefluxAi
                </div>
                <div className='text-md font-medium'>Master Your Trades with AI:</div>
                <div className=' font-medium'> The Ultimate Journal & Analytics Hub</div>
            </div>
            <div>
                <div>
                </div>
