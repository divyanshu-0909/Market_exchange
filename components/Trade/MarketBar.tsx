...
import { getTicker } from "@/hooks/getTicker";
...
import sol from "@/app/assets/sol.webp"
import usdc from "@/app/assets/usdc.webp"
export const MarketBar = ({market}: {market: string}) => {
    ...
    return <div>
        <div className="flex items-center flex-row relative w-full overflow-hidden border-b border-slate-600">
...
function Ticker({market}: {market: string}) {
    return <div className="flex h-[60px] shrink-0 space-x-4">
        <div className="flex flex-row relative ml-2 -mr-4">
            <Image width={50} height={50} alt="SOL Logo" loading="lazy" decoding="async" data-nimg="1" className="z-10 rounded-full h-6 w-6 mt-4 outline-baseBackgroundL1"  src={sol} />
            <Image width={50} height={50} alt="USDC Logo" loading="lazy"decoding="async" data-nimg="1" className="h-6 w-6 -ml-2 mt-4 rounded-full" src={usdc} />
        </div>
